...
public class HeightResizerOverlay extends Overlay {
    ...
    @Inject
    protected ResizableChatConfig config;
    @Inject
    protected ConfigManager configManager;
    @Inject
    protected ResizableChatPlugin plugin;
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        graphics.drawImage(client.getVarbitValue(Varbits.TRANSPARENT_CHATBOX) == 0 ? ResizableChatPlugin.resizeVBrown
            : ResizableChatPlugin.resizeV, 0, 0, null);
